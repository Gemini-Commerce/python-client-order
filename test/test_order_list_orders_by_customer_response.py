...
class TestOrderListOrdersByCustomerResponse(unittest.TestCase):
    """OrderListOrdersByCustomerResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrderListOrdersByCustomerResponse:
        """Test OrderListOrdersByCustomerResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrderListOrdersByCustomerResponse`
        """
        model = OrderListOrdersByCustomerResponse()
        if include_optional:
    ...
    def testOrderListOrdersByCustomerResponse(self):
        """Test OrderListOrdersByCustomerResponse"""
