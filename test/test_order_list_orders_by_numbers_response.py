...
class TestOrderListOrdersByNumbersResponse(unittest.TestCase):
    """OrderListOrdersByNumbersResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrderListOrdersByNumbersResponse:
        """Test OrderListOrdersByNumbersResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrderListOrdersByNumbersResponse`
        """
        model = OrderListOrdersByNumbersResponse()
        if include_optional:
    ...
    def testOrderListOrdersByNumbersResponse(self):
        """Test OrderListOrdersByNumbersResponse"""
